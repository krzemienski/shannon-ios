...
extension Project {
    var sessionCount: Int { 0 }  // TODO: Track sessions from backend
    var toolCount: Int { 0 }  // TODO: Track tools from backend
    ...
    // Removed mock data - now using real data from backend via ProjectsViewModel
}
